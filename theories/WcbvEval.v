...
Section Wcbv.
  ...
  | eval_app_ind t i u l l' : l <> nil ->
      eval t (tInd i u) ->
      Forall2 eval l l' ->
      eval (mkApps t l) (tApp (tInd i u) l')
  ...
  | eval_app_constr f i k u l l' : l <> nil ->
      ...
      Forall2 eval l l' ->
      eval (mkApps f l) (tApp (tConstruct i k u) l')
  ...
  Lemma eval_evals_ind :
    forall P : term -> term -> Prop,
      ...
      (forall (f8 : term) (i : inductive) (u : universe_instance) (l l' : list term),
          ...
          P f8 (tInd i u) -> Forall2 eval l l' -> Forall2 P l l' -> P (mkApps f8 l) (tApp (tInd i u) l')) ->
      ...
      (forall (f8 : term) (i : inductive) (k : nat) (u : universe_instance) (l l' : list term),
          ...
          P f8 (tConstruct i k u) -> Forall2 eval l l' -> Forall2 P l l' -> P (mkApps f8 l) (tApp (tConstruct i k u) l')) ->
  ...
  Proof.
    ...
    clear H. revert l l' H1. fix aux 3. destruct 1. constructor; auto.
    constructor. now apply eval_evals_ind. now apply aux.
    clear H. revert l l' H1. fix aux 3. destruct 1. constructor; auto.
    constructor. now apply eval_evals_ind. now apply aux.
  Defined.
